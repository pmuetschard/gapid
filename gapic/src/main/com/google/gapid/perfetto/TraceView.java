...
public class TraceView {
  ...
  public static Composite show(Composite parent, Client client, Capture capture, Widgets widgets) {
    ViewerPage page = new ViewerPage(parent, widgets.theme);

    FrontEnd fe = new FrontEnd(page);
    ControllerGlobals.INSTANCE.initialize(
        page, new Engine.GapisEngine(widgets.statusBar, client, capture.getData().path), new AppController(), fe);
